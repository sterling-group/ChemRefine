...
- **Engines** are plugins. Read the "Adding a new engine" recipe in
  [`src/chemrefine/engines/base.py`](src/chemrefine/engines/base.py)
  before adding one — it names the base class to subclass for each shape
  of backend.

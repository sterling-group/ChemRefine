...
def test_mlff_direct_atoms_from_output_falls_back_to_seed():
    from chemrefine.engines.mlff import engine as direct
...
def test_mlff_direct_atoms_from_output_raises_without_fallback():
    from chemrefine.engines.mlff import engine as direct
...
def test_mlff_direct_forces_from_gradient_converts_units():
    import numpy as np
...
def test_mlff_direct_forces_from_gradient_handles_none():
    from chemrefine.engines.mlff import engine as direct

    assert direct._forces_from_gradient(None) is None


def test_mlff_direct_forces_from_gradient_handles_empty():
    from chemrefine.engines.mlff import engine as direct
